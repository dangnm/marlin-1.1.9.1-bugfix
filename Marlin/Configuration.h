...
#define CUSTOM_MACHINE_NAME "Marlin 1.1.9.1" //Customized DBP
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // set to true to invert the logic of the probe. //Customized Wilber
